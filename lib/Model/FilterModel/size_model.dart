...
class SizeModel extends BaseMappable {
  bool status;
  int code;
  String msg;
  Data data;

  SizeModel({this.status, this.code, this.msg, this.data});
  ...
  Mappable fromJson(Map<String, dynamic> json) {
    ...
    msg = json['msg'];
    data = json['data'] != null ? new Data.fromJson(json['data']) : null;
    return SizeModel(status: status,msg: msg,code: code,data: data);
  }
}

class Data {
  List<SizeData> size_data;
  Meta meta;

  Data({this.size_data, this.meta});

  Data.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      size_data = new List<SizeData>();
      json['data'].forEach((v) {
        size_data.add(new SizeData.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.size_data != null) {
      data['data'] = this.size_data.map((v) => v.toJson()).toList();
    }
    if (this.meta != null) {
