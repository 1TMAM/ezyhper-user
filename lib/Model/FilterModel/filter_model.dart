...
/*
class FilterModel extends BaseMappable{
bool status;
int code;
String msg;
Data data;

FilterModel({this.status, this.code, this.msg, this.data});
...
Map<String, dynamic> toJson() {
  ...
  Mappable fromJson(Map<String, dynamic> json) {
    ...
    msg = json['msg'];
    data = json['data'] != null ? new Data.fromJson(json['data']) : null;
    return FilterModel(status: status,msg: msg,code: code,data: data);
  }
}
...
class FilterModel extends BaseMappable{
  ...
  Mappable fromJson(Map<String, dynamic> json) {
    ...
    msg = json['msg'];
    data = json['data'] != null ? new Data.fromJson(json['data']) : null;
    return FilterModel(status: status,code: code,msg: msg,data: data);
  }
}
...
/*class Products {
  ...
  String code;
  int mostSelling;
  String numberArrangementUnitsSameItem;
  int countRates;
  int totalRate;
  int inFavorite;
  SubCategory subCategory;
