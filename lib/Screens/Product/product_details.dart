...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  void initState() {
    ...
    super.initState();
    qty = 1;
    product_quantity = widget.product.quantity;
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: product_status
                              ? product_review(rates: widget.product.rates)
                              : product_details(),
                        ),
                        SizedBox(
                          height: width * .01,
            ...
            Container(
                ...
                child: Row(
                  children: [
                    ...
                    MyText(
                        text:
                            "${widget.product.code ?? translator.translate("not found")}",
                        size: StaticData.get_height(context) * .02),
                  ],
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                ),
              ...
              child: Row(
                children: [
                  MyText(
                      ...
                      size: StaticData.get_height(context) * .02),
                  MyText(
                      text: widget.product.shape == null
                          ? "${translator.translate("not found")}"
                          : "${widget.product.shape} ${translator.translate("Cm")} ",
                      size: StaticData.get_height(context) * .02),
                ],
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
              ),
  ...
  Widget product_review({List<purchased_model.Rates> rates}) {
    double width = MediaQuery.of(context).size.width;
