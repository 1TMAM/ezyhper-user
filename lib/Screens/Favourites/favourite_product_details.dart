                      ...
                      children: [
                          ...
                          children: [
                            Container(
                              ...
                              child: Wrap(
                                children: [
                                  MyText(
                                    text: "${widget.favourite_product.description}",
                                    size: height * .018,
                        ...
                        Container(
                          ...
                          child: product_status
                              ? product_review(rates: widget.favourite_product.rates)
                              : product_details(),
                        ),
                        SizedBox(
                          height: width * .01,
                                        ...
                                        if (_cart_status == 0) {
                                          ...
                                          DB_Helper.insert_product(new Product(
                                              ...
                                              prod_pricture: widget
                                                  .favourite_product.files.isEmpty
                                              ...
                                              prod_main_quantity:
                                              widget.favourite_product.quantity,
                                              prod_discount:
                                              widget.favourite_product.discount,
                                              prod_price_after_discount: widget
                                                  .favourite_product.priceAfterDiscount,
                        ...
                        Container(
                            ...
                            child: ProductView(
                              ...
                              product_id: widget.favourite_product.id,
            ...
            Container(
                ...
                child: Row(
                  children: [
                    ...
                    MyText(
                        text:
                        "${widget.favourite_product.code ?? translator.translate("not found")}",
                        size: StaticData.get_height(context) * .02),
                  ],
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                ),
              ...
              child: Row(
                children: [
                  MyText(
                      ...
                      size: StaticData.get_height(context) * .02),
                  MyText(
                      text: widget.favourite_product.shape == null
                          ? "${translator.translate("not found")}"
                          : "${widget.favourite_product.shape} ${translator.translate("Cm")} ",
                      size: StaticData.get_height(context) * .02),
                ],
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
              ),
                      ...
                      children: [
                        Container(
                          padding: EdgeInsets.only(
                              ...
                              right: StaticData.get_width(context) *
                                  .05),
                          child: Row(
                            mainAxisAlignment:
                            MainAxisAlignment.spaceBetween,
                        ...
                        Container(
                          ...
                          color: greyColor,
                          height:
                          StaticData.get_height(context) * .001,
                        )
                      ],
                    ),
                  ),
