...
class SubCategoryProductResult extends StatefulWidget {
  ...
  SubCategoryProductResult(
      {this.category_id, this.subcategory_name, this.sub_category_id});
  @override
  _SubCategoryProductResultState createState() =>
      _SubCategoryProductResultState();
}
