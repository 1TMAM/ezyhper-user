...
class CategoryProductsModel extends BaseMappable{
  bool status;
  int code;
  String msg;
  Data data;

  CategoryProductsModel({this.status, this.code, this.msg, this.data});
  ...
  Mappable fromJson(Map<String, dynamic> json) {
    ...
    msg = json['msg'];
    data = json['data'] != null ? new Data.fromJson(json['data']) : null;
    return CategoryProductsModel(status: status,msg: msg,code: code,data: data);
  }
}
