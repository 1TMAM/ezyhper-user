...
class CashoutModel extends BaseMappable{
  bool status;
  int code;
  String msg;
  Data data;

  CashoutModel({this.status, this.code, this.msg, this.data});
  ...
  Mappable fromJson(Map<String, dynamic> json) {
    ...
    msg = json['msg'];
    data = json['data'] != null ? new Data.fromJson(json['data']) : null;
    return CashoutModel(status: status,msg: msg,code: code,data: data);
  }
}
