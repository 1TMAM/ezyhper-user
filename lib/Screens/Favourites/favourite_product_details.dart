...
class _FavouriteProductDetailsState extends State<FavouriteProductDetails> {
  ...
  void initState() {
    ...
    qty = 1;
    product_quantity = widget.favourite_product.quantity;
    print("product_quantity : ${product_quantity}");
    product_status = false;

    favourite_status = widget.favourite_product.inFavorite == 0 ? false : true;
  }
                          ...
                          children: [
                            InkWell(
                              onTap: () {
                                ...
                                Share.share(
                                    '${widget.favourite_product.files[0].url}',
                                    subject: translator
                                        .translate("Welcome To Ezhyper"),
                                    sharePositionOrigin:
                            ...
                            Container(
                              ...
                              child: favourite_status
                                  ? IconButton(
                                      ...
                                      onPressed: (StaticData.vistor_value ==
                                              'visitor')
                                          ? null
                                          : () async {
                                              await favourite_bloc
                                                  .add(removeFavourite_click(
                                                product_id:
                                                    widget.favourite_product.id,
                                              ));
                                              setState(() {
                                                favourite_status =
                                                    !favourite_status;
                    ...
                    whiteColor,borderRadius: BorderRadius.circular(height*.05)),child: Column(children: [
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            MyText(text: "${widget.favourite_product.name} ", size: height*.02),
                          ],),
                      ),
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: [
                          MyText(text: "${widget.favourite_product.priceAfterDiscount} ${translator.translate("SAR")} ", size: height*.02),
                          SizedBox(width: width*.02,),
                          Row(
                            children: [
                              Text(
                                "${widget.favourite_product.price} ${translator.translate("SAR")}",
                                style: TextStyle(
                                    decoration:
                              ...
                              MyText(
                                  text: "${widget.favourite_product.discount}%",
                                  size: height * .011,
                                  color: greenColor),
                            ],
                          ),
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                RatingBar.readOnly(
                                  initialRating: widget.favourite_product.totalRate.toDouble(),
                                  maxRating: 5,
                                  isHalfAllowed: true,
                                  ...
                                  filledColor: (widget.favourite_product.totalRate.toDouble() >= 1)
                                ...
                                MyText(
                                  text: "(${widget.favourite_product.countRates})",
                                  size: height * .015,
                                  color: greyColor,
                                )
                              ],
                ...
                children: [
                  ...
                  whiteColor,borderRadius: BorderRadius.circular(height*.05)),child: Column(children: [
                    Row(mainAxisAlignment: MainAxisAlignment.start,children: [
                      FittedBox(
                        child: Container(padding: EdgeInsets.only(left: width*.05,right: width*.05),
                            width: width,
                            height: width*.1,
                            child: Wrap(
                              children: [
                                MyText(text: "${widget.favourite_product.description}",
                    ...
                    Container(
                      ...
                      child:         product_status? product_review(rates: widget.favourite_product.rates) : product_details()  ,
                    ),
                    SizedBox(height: height*.03,),
                    Container(
                      padding: EdgeInsets.only(
                          ...
                          top:  StaticData.get_width(context)* 0.05),
                      child:  Row(
                        children: [
                          Container(
                            decoration: BoxDecoration(
                                  ...
                                  onPressButton: (){
                                    ...
                                    if(_cart_status ==0){
                                      ...
                                      DB_Helper.insert_product(new Product(
                                          prod_id:  widget.favourite_product.id,
                                          prod_name :  widget.favourite_product.name,
                                          prod_price :  widget.favourite_product.price,
                                          prod_pricture :  widget.favourite_product.files.isEmpty ?'https://eazyhyper.wothoq.co/public/media/categories/yOHvUbpcnTrh58YWwdYb9BNUzorReMyDeabG1m95.jpg'
                                              : widget.favourite_product.files[0].url,
                                          prod_chossed_quantity : qty ,
                                          prod_main_quantity :  widget.favourite_product.quantity,
                                          prod_discount:  widget.favourite_product.discount,
                                          prod_price_after_discount: widget.favourite_product.priceAfterDiscount,
            ...
            Container(
                ...
                child: Row(
                  children: [
                    ...
                    MyText(
                        text: "${widget.favourite_product.code}",
                        size: StaticData.get_height(context) * .02),
                  ],
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                ),
              ...
              child: Row(
                children: [
                  MyText(
                      ...
                      size: StaticData.get_height(context) * .02),
                  MyText(
                      text: "${widget.favourite_product.size}",
                      size: StaticData.get_height(context) * .02),
                ],
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
              ),
              ...
              child: Row(
                children: [
                  MyText(
                      ...
                      size: StaticData.get_height(context) * .02),
                  MyText(
                      text: "24 ${translator.translate("Cm")} ",
                      size: StaticData.get_height(context) * .02),
                ],
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
              ),
  ...
  Widget product_review({List<favourite_model.Rates> rates}){
